...
export TOK='eyJhIjoiMDhmNDA4NjVlNzljMDNhMjE4YjQwYzYwYmQyYjQ0OTEiLCJ0IjoiMjJjMzBiYmMtYTBlMi00MTE3LTg2ZmItMGRmYmVjOTEwYWYwIiwicyI6Ik1XVmhOVGRqWVRVdE1ERTVZeTAwT0dVMUxXSmpOVFF0WldRM01UazROelUwTW1FMyJ9' 
export ARGO_DOMAIN='goorm.uuy-yydss.bf'
#=======================================
#设置哪吒参数(NEZHA_TLS='1'开启tls,设置其他关闭tls)
export NEZHA_SERVER='koyeb.uuidkuy.com'
export NEZHA_KEY='LHRZJXX1XH4TvEH7JQ'
export NEZHA_PORT='443'
export NEZHA_TLS='1'
#=======================================
# 下面设置UUID和路径，CF_IP是优选IP，SUB_NAME为节点名称
export UUID='f50d0913-098e-4c51-bb88-f7ea6d40cc33'
